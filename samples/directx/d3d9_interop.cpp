...
{
public:
    D3D9WinApp(int width, int height, std::string& window_name, ncvslideio::VideoCapture& cap) :
    ...
    int create(void)
    {
        ...
        {
            m_oclCtx = ncvslideio::directx::ocl::initializeContextFromDirect3DDevice9(m_pD3D9Dev);
        }
