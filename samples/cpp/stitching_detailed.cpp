...
int main(int argc, char* argv[])
{
...
#if 0
    ncvslideio::setBreakOnError(true);
#endif
    ...
    {
        if (warp_type == "plane")
            warper_creator = makePtr<ncvslideio::PlaneWarperGpu>();
        else if (warp_type == "cylindrical")
            warper_creator = makePtr<ncvslideio::CylindricalWarperGpu>();
        else if (warp_type == "spherical")
            warper_creator = makePtr<ncvslideio::SphericalWarperGpu>();
    }
    else
#endif
    {
