...
namespace ncvslideio { namespace internal {
...
struct CV_EXPORTS IntrinsicParams
{
    ...
    IntrinsicParams& operator =(const Mat& a);
    void Init(const ncvslideio::Vec2d& f, const ncvslideio::Vec2d& c, const ncvslideio::Vec4d& k = Vec4d(0,0,0,0), const double& alpha = 0);
};

void projectPoints(ncvslideio::InputArray objectPoints, ncvslideio::OutputArray imagePoints,
...
void dAB(ncvslideio::InputArray A, InputArray B, OutputArray dABdA, OutputArray dABdB);
