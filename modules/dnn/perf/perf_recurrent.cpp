...
PERF_TEST_P_(Layer_LSTM, lstm) {
    ...
    Mat weightH(params.hiddenSize * 4, params.hiddenSize, CV_32FC1, ncvslideio::Scalar(0));
    Mat weightX(params.hiddenSize * 4, params.inputSize, CV_32FC1, ncvslideio::Scalar(0));
    Mat bias(params.hiddenSize * 4, 1, CV_32FC1, ncvslideio::Scalar(0));
    Mat hInternal(params.nrSteps, params.hiddenSize, CV_32FC1, ncvslideio::Scalar(0));
    Mat cInternal(params.nrSteps, params.hiddenSize, CV_32FC1, ncvslideio::Scalar(0));
