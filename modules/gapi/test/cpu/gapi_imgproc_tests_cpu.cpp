...
namespace
{
#define IMGPROC_CPU [] () { return ncvslideio::compile_args(ncvslideio::gapi::use_only{ncvslideio::gapi::imgproc::cpu::kernels()}); }
...
INSTANTIATE_TEST_CASE_P(ResizeTestCPU, ResizeTest,
                        Combine(Values(CV_8UC1, CV_8UC3, CV_16UC1, CV_16SC1, CV_32FC1),
                                ...
                                Values(ncvslideio::Size(64,64),
                                       ncvslideio::Size(30,30))));
...
INSTANTIATE_TEST_CASE_P(Filter2DTestCPU, Filter2DTest,
                        Combine(Values(CV_8UC1, CV_8UC3, CV_16UC1, CV_16SC1, CV_32FC1),
                                ...
                                Values(ncvslideio::Size(3, 3),
                                       ncvslideio::Size(4, 4),
                                       ncvslideio::Size(5, 5),
                                       ncvslideio::Size(7, 7)),
                                Values(ncvslideio::BORDER_DEFAULT)));
...
INSTANTIATE_TEST_CASE_P(ErodeTestCPU, ErodeTest,
                        Combine(Values(CV_8UC1, CV_8UC3, CV_16UC1, CV_16SC1, CV_32FC1),
                                ...
                                Values(AbsExact().to_compare_obj()),
                                Values(3, 5),
                                Values(ncvslideio::MorphShapes::MORPH_RECT,
                                       ncvslideio::MorphShapes::MORPH_CROSS,
                                       ncvslideio::MorphShapes::MORPH_ELLIPSE)));
...
INSTANTIATE_TEST_CASE_P(MorphologyExTestCPU, MorphologyExTest,
                        Combine(Values(CV_8UC1, CV_8UC3, CV_16UC1, CV_16SC1, CV_32FC1),
                                ...
                                Values(IMGPROC_CPU),
                                Values(AbsExact().to_compare_obj()),
                                Values(ncvslideio::MorphTypes::MORPH_ERODE,
                                       ncvslideio::MorphTypes::MORPH_DILATE,
                                       ncvslideio::MorphTypes::MORPH_OPEN,
                                       ncvslideio::MorphTypes::MORPH_CLOSE,
                                       ncvslideio::MorphTypes::MORPH_GRADIENT,
                                       ncvslideio::MorphTypes::MORPH_TOPHAT,
                                       ncvslideio::MorphTypes::MORPH_BLACKHAT)));
...
INSTANTIATE_TEST_CASE_P(MorphologyExHitMissTestCPU, MorphologyExTest,
                        Combine(Values(CV_8UC1),
                                ...
                                Values(IMGPROC_CPU),
                                Values(AbsExact().to_compare_obj()),
                                Values(ncvslideio::MorphTypes::MORPH_HITMISS)));
...
INSTANTIATE_TEST_CASE_P(GoodFeaturesTestCPU, GoodFeaturesTest,
                        Combine(Values(IMGPROC_CPU),
                                Values(AbsExactVector<ncvslideio::Point2f>().to_compare_obj()),
                                Values("ncvslideio/shared/fruits.png"),
...
INSTANTIATE_TEST_CASE_P(GoodFeaturesInternalTestCPU, GoodFeaturesTest,
                        Combine(Values(IMGPROC_CPU),
                                Values(AbsExactVector<ncvslideio::Point2f>().to_compare_obj()),
                                Values("ncvslideio/cascadeandhog/images/audrybt1.png"),
                                Values(CV_32FC1, CV_8UC1),
                                Values(100),
                                Values(0.0000001),
                                Values(5.0),
...
INSTANTIATE_TEST_CASE_P(BoundingRectMatVectorTestCPU, BoundingRectMatTest,
                        Combine(Values(CV_32S, CV_32F),
                                Values(ncvslideio::Size(1280, 1),
                                       ncvslideio::Size(128, 1)),
                                Values(-1),
                                Values(IMGPROC_CPU),
...
INSTANTIATE_TEST_CASE_P(FitLine2DMatVectorTestCPU, FitLine2DMatVectorTest,
                        Combine(Values(CV_8U, CV_8S, CV_16U, CV_16S,
                                ...
                                Values(ncvslideio::Size(8, 0), ncvslideio::Size(1024, 0)),
                                Values(-1),
                                Values(IMGPROC_CPU),
