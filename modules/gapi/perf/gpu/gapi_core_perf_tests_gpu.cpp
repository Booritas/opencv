...
#define CORE_GPU ncvslideio::gapi::core::gpu::kernels()
...
INSTANTIATE_TEST_CASE_P(AddPerfTestGPU, AddPerfTest,
    Combine(Values(AbsExact().to_compare_f()),
            ...
            Values(ncvslideio::compile_args(CORE_GPU))));
...
INSTANTIATE_TEST_CASE_P(ThresholdPerfTestGPU, ThresholdPerfTest,
    Combine(Values(AbsExact().to_compare_f()),
            ...
            Values(ncvslideio::THRESH_BINARY, ncvslideio::THRESH_BINARY_INV,
                   ncvslideio::THRESH_TRUNC, ncvslideio::THRESH_TOZERO, ncvslideio::THRESH_TOZERO_INV),
            Values(ncvslideio::compile_args(CORE_GPU))));
