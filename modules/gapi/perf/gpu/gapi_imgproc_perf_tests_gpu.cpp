...
#define IMGPROC_GPU ncvslideio::gapi::imgproc::gpu::kernels()
...
INSTANTIATE_TEST_CASE_P(SepFilterPerfTestGPU_8U, SepFilterPerfTest,
                        Combine(Values(ToleranceFilter(1e-4f, 0.01).to_compare_f()),
                                ...
                                Values(ncvslideio::compile_args(IMGPROC_GPU))));
...
INSTANTIATE_TEST_CASE_P(BoxFilterPerfTestGPU, BoxFilterPerfTest,
                        Combine(Values(ToleranceFilter(1e-4f, 0.01).to_compare_f()),
                                ...
                                Values(ncvslideio::BORDER_DEFAULT),
                                Values(-1, CV_32F),
                                Values(ncvslideio::compile_args(IMGPROC_GPU)))); //TODO: 8UC1 doesn't work
