...
#define RENDER_OCV ncvslideio::gapi::render::ocv::kernels()
...
INSTANTIATE_TEST_CASE_P(RenderTestFTexts, RenderTestFTexts,
                        Combine(Values(L"\xe4\xbd\xa0\xe5\xa5\xbd"),
                                ...
                                Values(ncvslideio::Point(50, 50)),
                                Values(60),
                                Values(ncvslideio::Scalar(200, 100, 25)),
                                Values(ncvslideio::compile_args(RENDER_OCV))));
#endif // HAVE_FREETYPE
...
INSTANTIATE_TEST_CASE_P(RenderTestImages, RenderTestImages,
                        Combine(Values(szVGA, sz720p, sz1080p),
                                Values(ncvslideio::Rect(50, 50, 100, 100)),
