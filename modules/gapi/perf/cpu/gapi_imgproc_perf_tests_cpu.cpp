...
#define IMGPROC_CPU ncvslideio::gapi::imgproc::cpu::kernels()
...
INSTANTIATE_TEST_CASE_P(SepFilterPerfTestCPU_8U, SepFilterPerfTest,
    Combine(Values(AbsExact().to_compare_f()),
        ...
        Values(ncvslideio::compile_args(IMGPROC_CPU))));
...
INSTANTIATE_TEST_CASE_P(GoodFeaturesPerfTestCPU, GoodFeaturesPerfTest,
    Combine(Values(AbsExactVector<ncvslideio::Point2f>().to_compare_f()),
