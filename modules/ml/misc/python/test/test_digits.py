...
class digits_test(NewOpenCVTests):
    ...
    def test_digits(self):
        ...
        self.assertLess(ncvslideio.norm(confusionMatrixes[0] - confusionKNN, ncvslideio.NORM_L1), normEps)
        self.assertLess(ncvslideio.norm(confusionMatrixes[1] - confusionSVM, ncvslideio.NORM_L1), normEps)
