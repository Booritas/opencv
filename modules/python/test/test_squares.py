...
def intersectionRate(s1, s2):
    area, _intersection = ncvslideio.intersectConvexConvex(np.array(s1), np.array(s2))
    return 2 * area / (ncvslideio.contourArea(np.array(s1)) + ncvslideio.contourArea(np.array(s2)))
