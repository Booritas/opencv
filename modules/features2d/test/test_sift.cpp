...
TEST(Features2d_SIFT, descriptor_type)
{
    ...
    Ptr<SIFT> siftFloat = ncvslideio::SIFT::create(0, 3, 0.04, 10, 1.6, CV_32F);
    siftFloat->detectAndCompute(gray, Mat(), keypoints, descriptorsFloat, false);
    ASSERT_EQ(descriptorsFloat.type(), CV_32F) << "type mismatch";

    Ptr<SIFT> siftUchar = ncvslideio::SIFT::create(0, 3, 0.04, 10, 1.6, CV_8U);
...
{
    auto extractor = ncvslideio::SIFT::create();
    ncvslideio::Mat1b image{ncvslideio::Size{300, 300}, 0};
    std::vector<ncvslideio::KeyPoint> kps {
        ncvslideio::KeyPoint(154.076813f, 136.160904f, 111.078636f, 216.195618f, 0.00000899323549f, 7)
    };
