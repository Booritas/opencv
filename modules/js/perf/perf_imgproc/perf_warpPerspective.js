...
function perf() {
    ...
    function addWarpPerspectiveCase(suite, type) {
        suite.add('warpPerspective', function() {
            ncvslideio.warpPerspective(src, dst, warpMat, sz, interType, borderMode, borderColor);
          }, {
              'setup': function() {
                ...
                let rotMat = ncvslideio.getRotationMatrix2D(new ncvslideio.Point(src.cols/2.0, src.rows/2.0), 30.0, 2.2);
                let warpMat = new ncvslideio.Mat(3, 3, ncvslideio.CV_64FC1);
