...
struct CvCascadeBoostTrainData : CvDTreeTrainData
{
    ...
    ncvslideio::Mat valCache; // precalculated feature values (CV_32FC1)
...
public:
    ...
    void write( ncvslideio::FileStorage &fs, const ncvslideio::Mat& featureMap );
    void read( const ncvslideio::FileNode &node, CvBoost* _ensemble, CvDTreeTrainData* _data );
    void markFeaturesInMap( ncvslideio::Mat& featureMap );
protected:
...
public:
    ...
    void write( ncvslideio::FileStorage &fs, const ncvslideio::Mat& featureMap ) const;
    bool read( const ncvslideio::FileNode &node, const CvFeatureEvaluator* _featureEvaluator,
               const CvCascadeBoostParams& _params );
    void markUsedFeaturesInMap( ncvslideio::Mat& featureMap );
protected:
