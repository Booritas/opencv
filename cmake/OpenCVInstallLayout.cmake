...
elseif(WIN32 AND CMAKE_HOST_SYSTEM_NAME MATCHES Windows)
  ...
  ocv_update(OPENCV_3P_LIB_INSTALL_PATH        "lib")
  ocv_update(OPENCV_CONFIG_INSTALL_PATH        ".")
  ocv_update(OPENCV_INCLUDE_INSTALL_PATH       "include")
  ocv_update(OPENCV_OTHER_INSTALL_PATH         "etc")
  ocv_update(OPENCV_SAMPLES_SRC_INSTALL_PATH   "samples")
  ocv_update(OPENCV_LICENSES_INSTALL_PATH      "licenses")
...
elseif(QNX)
  ...
  ocv_update(OPENCV_TEST_INSTALL_PATH          "tests")
  ocv_update(OPENCV_SAMPLES_BIN_INSTALL_PATH   "bin")
  ocv_update(OPENCV_LIB_INSTALL_PATH           "lib")
  ocv_update(OPENCV_LIB_ARCHIVE_INSTALL_PATH   "lib")
  ocv_update(OPENCV_3P_LIB_INSTALL_PATH        "lib")
  ocv_update(OPENCV_CONFIG_INSTALL_PATH        "cmake/opencv4")
  ocv_update(OPENCV_INCLUDE_INSTALL_PATH       "include")
  ocv_update(OPENCV_OTHER_INSTALL_PATH         "opencv4")
  ocv_update(OPENCV_SAMPLES_SRC_INSTALL_PATH   "samples")
  ocv_update(OPENCV_LICENSES_INSTALL_PATH      "licenses/opencv4")
  ocv_update(OPENCV_TEST_DATA_INSTALL_PATH     "testdata")
  ocv_update(OPENCV_DOC_INSTALL_PATH           "doc/opencv4")
  ocv_update(OPENCV_JAR_INSTALL_PATH           "java/opencv4")
  ocv_update(OPENCV_JNI_INSTALL_PATH           "${OPENCV_JAR_INSTALL_PATH}")
  ocv_update(OPENCV_JNI_BIN_INSTALL_PATH       "${OPENCV_JNI_INSTALL_PATH}")
